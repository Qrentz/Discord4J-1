...
public class MessageList extends AbstractList<IMessage> implements List<IMessage> {
	...
	public void bulkDelete(List<IMessage> messages) {
		PermissionUtil.checkPermissions(channel, client.getOurUser(), Permissions.MANAGE_MESSAGES);
	...
	private boolean hasPermissions() {
		try {
			PermissionUtil.checkPermissions(channel, client.getOurUser(), Permissions.READ_MESSAGES, Permissions.READ_MESSAGE_HISTORY);
			return true;
